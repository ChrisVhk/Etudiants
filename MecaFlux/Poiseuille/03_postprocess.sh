#!/bin/bash
# ==============================================================================
# 03_postprocess.sh — Post-traitement complet du TP Poiseuille
# Lance tous les scripts Python dans le bon ordre et vérifie les dépendances.
# Appelé par : bash tp_poiseuille.sh 3-7  (ou directement)
# ==============================================================================
...
if [[ "$HAS_RESULTS" == false ]]; then
    ...
    error "Lancez d'abord : bash 01_setup.sh && bash 02_run.sh"
    exit 1
fi
